 ...
 * @time on 2017/10/9
 */
public class PackgeOneListAdapter extends MyBaseAdapter {

    private Context context;
    private List<PackagesVo.Products1Bean.ProductsBean> list;

    public PackgeOneListAdapter(Context context, List<PackagesVo.Products1Bean.ProductsBean> list) {
        super();
