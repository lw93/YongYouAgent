 ...
 * @time on 2017/10/9
 */
public class PackgeQuryListAdapter extends MyBaseAdapter {

    private Context context;
    private List<PackagesByPriceVo.ProductsBean> list;

    public PackgeQuryListAdapter(Context context,List<PackagesByPriceVo.ProductsBean> list) {
        super();
